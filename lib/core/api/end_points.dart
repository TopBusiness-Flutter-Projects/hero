class EndPoints {
 ...
 // static const String searchUrl = '${baseUrl}search';
  ...
  static const String countTripsAndNotifications = '${baseUrl}countTripsAndNotifications';
  ...
  static const String searchTextUrl = googleBaseUrl+'place/textsearch/json';
