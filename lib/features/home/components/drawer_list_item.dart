...
class DrawerListItem extends StatelessWidget {
 ...
 const  DrawerListItem({super.key,required this.drawerItemModel,required this.textColor });
...
List<DrawerItemModel> drawerItems = [
  DrawerItemModel(imagePath:ImageAssets.trips ,title: "trip_insurance_service"),
  ...
  DrawerItemModel(imagePath:ImageAssets.favouriteTitles ,title: "favourite_titles"),
  DrawerItemModel(imagePath:ImageAssets.aboutHero ,title: "about_hero"),
  DrawerItemModel(imagePath:ImageAssets.technicalSupport ,title: "contact_support"),
