      ...
      body: SafeArea(
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        children: [
                          Text("وقت الركوب",style: TextStyle(
                    ...
                    Container(
                        child: Image.asset("assets/images/mini_car.png",width: getSize(context)*0.13,)),
                      Column(
                        children: [
                          Text("وقت الوصول",style: TextStyle(
                      color: AppColors.black,
                          fontSize: getSize(context)*0.04
                             ),),
                          Text("7:10 PM",style: TextStyle(
                  ...
                  Row(children: [
                    ...
                    Text("0.5 km",style: TextStyle(
                        fontSize: getSize(context)*0.04
                    ),),
                    SizedBox(width: getSize(context)*0.15,),
                    Image.asset("assets/images/clock.png",height: getSize(context)*0.05,),
                  //  Icon(Icons.watch_later_outlined,),
                    SizedBox(width: getSize(context)*0.02,),
                    Text("15 min",style: TextStyle(
                        fontSize: getSize(context)*0.04
                    ),),
                    SizedBox(width: getSize(context)*0.15,),
                    Image.asset("assets/images/money.png",height: getSize(context)*0.05,),
                    SizedBox(width: getSize(context)*0.02,),
                    Text("15 د.ع",style: TextStyle(
                        fontSize: getSize(context)*0.04
                    ),),
                  ],),
                  SizedBox(height: 10,)
            ...
            CustomButton(text: 'rate_trip'.tr(), color: AppColors.primary, onClick: () {
              showDialog(
                context: context,
                builder: (context) {
                  return Container(
                    ...
                    child:Dialog(
                      ...
                      child: Column(
                        ...
                        print(rating);
                          ...
                          }, child: Text("confirm".tr(),style: TextStyle(color: AppColors.green1),),
              ...
              width: getSize(context)*0.9,height: getSize(context)*0.14,)
          ],
        ),
      ),
    );
