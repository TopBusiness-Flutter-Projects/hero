        ...
        children: [
          InkWell(
            onTap: () {
             ...
             // context.read<HomeCubit>().search(favouriteData.address!);
//              context.read<HomeCubit>().setSearchResult(LatLng(double.parse(favouriteData.lat.toString()),double.parse(favouriteData.long.toString()) ));
