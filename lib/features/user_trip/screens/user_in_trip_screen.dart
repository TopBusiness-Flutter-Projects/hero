...
import 'package:hero/features/user_trip/screens/widgets/no_driver_widget.dart';
            ...
            builder: (context, state) => Column(
              children: [
                ...
                BlocConsumer<HomeCubit, HomeState>(listener: (context, state) {
                  if (state is SuccessIndicatorState) {
                    cubit.tripStages = 4;
                  }
                  ...
                  if (context.read<HomeCubit>().checkTripStatusModel.data !=
                    ...
                    if (context
                      ...
                      //     context.read<HomeCubit>().checkTripStatusModel.data);
                            ...
                            .type ==
                        'new') {
                      if (cubit.tripStages != 4) cubit.getWaitingDriverStage();
